...
import { ingestTransxchangeDirectory } from "./ingester.js";
import type { DepartureResponse, LocationResponse, ServiceResponse } from "../../api/types.js";
...
const basicPentlandScenario: Scenario = {
  fixtureDir: "src/ingesters/transxchange/fixtures/01-basic-real",
...
const nonOperationScenario: Scenario = {
  fixtureDir: "src/ingesters/transxchange/fixtures/03-non-operation-real",
...
const bankHolidayScenario: Scenario = {
  fixtureDir: "src/ingesters/transxchange/fixtures/04-bank-holiday-real",
...
const multiFileScenario: Scenario = {
  fixtureDir: "src/ingesters/transxchange/fixtures/07-multi-file-same-service-real",
