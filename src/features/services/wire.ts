...
function vesselToApi(vessel: VesselResponse): VesselApiResponse {
  return {
    mmsi: vessel.mmsi,
    name: vessel.name,
...
function timetableDocumentToApi(document: TimetableDocumentResponse): TimetableDocumentApiResponse {
  return {
    id: document.id,
