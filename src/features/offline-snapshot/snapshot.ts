...
import { londonLocalTimestampResponse, listLocationDepartureRows, listServicesWithScheduledDepartures } from "../services/read-model.js";
import { logger } from "../../shared/logger.js";

export {
  generateAndWriteOfflineSnapshot,
  readOfflineSnapshotMetadata
};
...
function readOfflineSnapshotMetadata(metadataPath = defaultSnapshotMetadataPath): OfflineSnapshotMetadata | null {
...
function generateAndWriteOfflineSnapshot(
