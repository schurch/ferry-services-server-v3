...
import { replaceTransxchangeData } from "./repository.js";
import type {
...
export {
  ingestTransxchangeDirectory,
  parseTransxchangeDirectory
};
...
function parseTransxchangeDirectory(directory: string): TransxchangeDocument[] {
...
function ingestTransxchangeDirectory(db: Database.Database, directory: string): void {
