...
import { defaultSnapshotMetadataPath, defaultSnapshotPath, readOfflineSnapshotMetadata } from "../offline-snapshot/snapshot.js";
import {
...
export async function registerApiDocumentation(app: FastifyInstance): Promise<void> {
  addSchemas(app);
